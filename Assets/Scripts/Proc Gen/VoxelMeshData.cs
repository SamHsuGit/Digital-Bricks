...
public class VertData
{
    ...
    {
        Vector3 center = new Vector3(0.5f, 0.5f, 0.5f); // The centre of the block that we are pivoting around.
        Vector3 direction = position - center; // Get the direction from the centre to the current vertice.
