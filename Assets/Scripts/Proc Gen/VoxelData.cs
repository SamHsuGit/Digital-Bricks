...
public static class VoxelData
{
	...
	public static readonly int ChunkHeight = 128; // original Minecraft World Height Limit = 128, found that a smaller chunkHeight is needed to reduce world load times to under 15 seconds
